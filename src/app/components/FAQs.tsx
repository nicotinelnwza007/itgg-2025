...
const faqs = [
  {
    ...
    answer:
      'ITGG (Infotech Tournament GateGame) คือ กิจกรรมแข่งขันเกมภายในคณะเทคโนโลยีสารสนเทศ สจล. (KMITL) ที่รวมความสนุก ความท้าทาย และความสามารถทั้งด้านเกม วาไรตี้ E-Sports และกีฬา ',
  },
  {
