...
const Hero = () => {
  return (
    <section className="flex justify-center items-center w-full h-[100vh] px-4 sm:px-6 lg:px-8 py-10 sm:py-14 md:py-20">
      <div className="max-w-5xl mx-auto flex flex-col items-center space-y-4 sm:space-y-5 md:space-y-6">
        ...
        {/* Text Section */}
        <div className="text-center px-2 sm:px-4 md:px-6 text-white">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 text-glow">
            ITGG-2025
          </h1>
        ...
        <div className="flex flex-row gap-3 sm:gap-4 justify-center items-center w-full sm:w-auto h-[10px] mt-2">
          ...
          <PrimaryButton href="/know">ตารางการแข่งขัน</PrimaryButton>
        </div>
      </div>
    </section>
  );
