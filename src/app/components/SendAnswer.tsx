  ...
  const dailyQuestsBefore25July = [
    {
      id: "1",
      question:
        "ถ่ายรูปเข้าร่วมฟังในกิจกรรม Special Event วันที่ 22 กรกฎาคม เวลา 16:00 น. ",
    },
    {
      id: "2",
      question: "ถ่ายรูปเข้าร่วมกิจกรรม Variety Day วันที่ 24 กรกฎาคม เวลา 16:00 น.",
    },
  ];
    ...
    return (
      <div className="w-full px-4 py-10 relative">
        <div className="flex items-center justify-center">
          <div className="text-[#6b3e1d] text-lg">
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                ...
                w-[90%] max-w-md bg-[#f4e8df] border-5 border-[#a05a2c] rounded-[2rem] p-8 shadow-2xl"
              >
                <button
                  onClick={closeModal}
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              transition={{ duration: 0.3, ease: "easeOut" }}
              className="fixed top-1/2 left-1/2 z-50 transform -translate-x-1/2 -translate-y-1/2 
                  w-[90%] max-w-md bg-pink-50 border-2 border-[] rounded-[2rem] p-8 shadow-2xl"
            >
              <button
                onClick={closeModal}
                className="absolute top-4 right-4 text-[#a05a2c] hover:text-[#a05a2cc7] z-10"
              ...
              {message && (
                <div
                  className={`mt-4 text-center font-semibold ${message.includes("Correct")
                    ? "text-green-600"
                    : "text-red-600"
                    }`}
                >
